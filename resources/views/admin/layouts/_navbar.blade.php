<ul class="navbar-nav mr-auto">
    ...
    @auth
        <li @if (Request::is('admin/posts*')) class="nav-item active" @else class="nav-item" @endif>
            <a class="nav-link" href="/admin/post">文章</a>
        </li>
        <li @if (Request::is('admin/tags*')) class="nav-item active" @else class="nav-item" @endif>
